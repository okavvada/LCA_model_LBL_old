...
- After you have installed docker, generate a docker image by running `docker build -t flask-lca-tea-model:latest .` in your terminal. You only need to perform this stem ONCE. Only the first time you install the LCA-TEA model. TO run the model go to the next step.
